...
using Novus.BooksModule.IntegrationTests.Extensions;
using Novus.BooksModule.IntegrationTests.Infrastructure;

namespace Novus.BooksModule.IntegrationTests
{
